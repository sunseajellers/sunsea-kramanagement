// Simple admin page for KRA scheduler
'use client'
...
export default function KRASchedulerPage() {
    useAuth()
    ...
    return (
        <div className="space-y-10 pb-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 uppercase tracking-tighter">Automation Engine</h1>
                            ...
                            {loading ? (
                                <tr>
                                    <td colSpan={7} className="py-20 text-center">
                                        ...
                                        <p className="text-[10px] font-black text-gray-300 uppercase tracking-[0.2em]">Synchronizing Automation Registry...</p>
                                    </td>
                                </tr>
                            ) : templates.length === 0 ? (
                                <tr>
